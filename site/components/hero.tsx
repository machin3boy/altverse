  ...
  return (
    <main className="flex flex-col items-center justify-center gap-4 z-10 relative">
      <Link href="/whitepaper.pdf" target="_blank" rel="noopener noreferrer" className="mb-2">
        <button className="flex items-center gap-1 px-3 py-1 rounded-full bg-gray-800/20 text-gray-500 hover:bg-gray-800/40 hover:text-gray-300 duration-300 text-xs font-semibold border border-gray-700/10 hover:border-gray-600/30">
      ...
      <BlurIn
        ...
        className="text-balance bg-gradient-to-br from-white from-30% to-white/50 bg-clip-text pb-2 text-center font-normal leading-tight tracking-tighter text-transparent sm:text-3xl md:text-4xl lg:text-[2.65rem]"
        duration={2}
      />
